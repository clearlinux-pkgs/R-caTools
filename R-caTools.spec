...
Version  : 1.17.1.3
Release  : 30
URL      : https://cran.r-project.org/src/contrib/caTools_1.17.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/caTools_1.17.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575282847
